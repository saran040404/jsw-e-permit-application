...
import 'authoriser_home.dart';

class AuthNewWork extends StatefulWidget {
  @override
  _AuthNewWorkState createState() => _AuthNewWorkState();
}

class _AuthNewWorkState extends State<AuthNewWork> {
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    _showDialog(context);// Submit button logic
                  },
                  style: ButtonStyle(
                    backgroundColor:
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return Center(
          child: Container(
            width: 325,
            height:275,// Set your desired width
            child: AlertDialog(
              title: Text('Your Permit Number'),
              content: Column(
                children: [
                  SizedBox(height: 10),
                  Row(
                    ...
                    children: [
                      Text(
                        '12345678', // Your 8-digit number here
                        style:
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    CloseToHome(context);// Submit button logic
                  },
                  child: Text('Close'),
                ),
              ],
  ...
  void CloseToHome(BuildContext context) {
    Navigator.push(
      context,
