...
class AuthWorkComplete extends StatefulWidget {
  @override
  _AuthWorkCompleteState createState() => _AuthWorkCompleteState();
}

class _AuthWorkCompleteState extends State<AuthWorkComplete> {
