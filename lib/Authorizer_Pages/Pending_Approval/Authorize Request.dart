...
class AuthorizeRequest extends StatefulWidget {
  @override
  _AuthorizeRequestState createState() => _AuthorizeRequestState();
}

class _AuthorizeRequestState extends State<AuthorizeRequest> {
  String rejectionReason = ''; // To store the rejection reason
  bool isTextBoxVisible = false; // Initially, the text box is not visible
  String? selectOption;
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    setState(() {
                      isTextBoxVisible =
                          !isTextBoxVisible; // Toggle the visibility
                    });
                  },
                  child: Text('Reject'),
                ),
              ...
              Visibility(
                ...
                // This controls the visibility of the text box
                child: Container(
                  width: 400,
                  child: Column(
                    children: [
                      TextFormField(
                        maxLines: 4,
                        decoration: InputDecoration(
                          hintText: 'Enter your rejection reason...',
                        ),
                        onChanged: (text) {
                          setState(() {
                            rejectionReason =
                                text; // Store the rejection reason
                          });
                        },
                      ),
                      SizedBox(height: 20.0),
