...
class Work_at_Height extends StatelessWidget {
  const Work_at_Height({super.key});
...
class _certificateState extends State<certificate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: Text('Work at Height Certificate'),
        ),
        body: ListView(
          children: [
            Padding(
              ...
              child: Material(
                ...
                child: Column(children: [
                  ...
                  Padding(
                    padding:  EdgeInsets.all(10.0),
                    child: Container(
                      child: Text('If Permit Applicant/Holder changed then their Name should be incorporated in the formate',style: TextStyle(fontSize: 16,color: Colors.red),),
                    ),
                  ),
                  Padding(
                ...
                child: Column(
                  children: [
                    Padding(
                      padding:EdgeInsets.all(10.0),
                      child: Container(
                        child: Text('Action Taken by Permit Holder:"Please tick the revelant action taken with this permit"(MANDATORY)',style: TextStyle(fontSize: 20,color: Colors.red),),
                      ),
                    ),
                    Padding(
                      padding: EdgeInsets.all(10.0),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Risk Assessment is been caried out for the job & attached with the permit(MANDATORY REQUIREMENT)',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Whether safe access to work place is provided',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Work platforms provided with gaurd rails',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Adequate fall protection arrangement made(Double Lanyard Harness,Fall arrestor,Life line,Safety Net)',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Are the Workermen are medically fit for working at height job',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Protection against Objects falling from above height',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Text(
                          'Whether area below,where the height work being performed is cordoned & unauthorised entires are restrected',
                          style: TextStyle(fontSize: 16),
                        ),
                      ),
                    ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: TextFormField(
                                onChanged: (value) {
                                  certificateData.transfer_applicant = value;
                                },
                                controller: Transfer_Applicant_NameController,
                                decoration: InputDecoration(
                                  border: OutlineInputBorder(),
                  ...
                  child:Column(
                    children: [
                      Padding(
                        ...
                        child: Container(
                          width: 300,
                          child: Text('Note:',style: TextStyle(fontSize: 20,color: Colors.red),),
                        ),
                      ),
                      Padding(
                        padding: EdgeInsets.all(10.0),
                        child: Container(
                          child: Text('1.This permit Applies only to work in the locatino described.Any further height work must another permit issued for prescribed validity',style: TextStyle(fontSize: 16),),
                        ),
                      ),
                      Padding(
                        padding: EdgeInsets.all(10.0),
                        child: Container(
                          child: Text('2.This permit only applies to the person to whome it is issued.If work has to be continued by someone else,this permit must be returned to issuer for cancellation and another permit issued.',style: TextStyle(fontSize: 16),),
                        ),
                      ),
                    ],
                  )
