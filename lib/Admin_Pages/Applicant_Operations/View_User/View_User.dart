...
import 'package:jsw_epermit/Admin_Pages/Applicant_Operations/View_User/View%20User%20Data.dart';
...
class ViewUserState extends State<ViewUser> {
  ...
  void _navigateToPage(String? value) {
    ...
    if (value == "102586") {
      Navigator.push(context, MaterialPageRoute(builder: (context) => ViewUserData()));
