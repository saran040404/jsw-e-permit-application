...
import 'package:jsw_epermit/Admin_Pages/Applicant_Operations/Remove_User/Remove%20User%20Data.dart';

class RemoveUser extends StatefulWidget {
  @override
  RemoveUserState createState() => RemoveUserState();
}

class RemoveUserState extends State<RemoveUser> {
  String? _selectedDIC;
  ...
  void _navigateToPage(String? value) {
    ...
    if (value == "102586") {
      Navigator.push(context, MaterialPageRoute(builder: (context) => RemoveUserData()));
