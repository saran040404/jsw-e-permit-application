...
import 'Modify_User_Data.dart';

class ModifyUserAuth extends StatefulWidget {
  @override
  ModifyUserAuthState createState() => ModifyUserAuthState();
}

class ModifyUserAuthState extends State<ModifyUserAuth> {
  String? _selectedDIC;
  ...
  void _navigateToPage(String? value) {
    ...
    if (value == "102586") {
      Navigator.push(context, MaterialPageRoute(builder: (context) => ModifyUserDataAuth()));
