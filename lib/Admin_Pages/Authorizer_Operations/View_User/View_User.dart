...
import 'View_User_Data.dart';

class ViewUserAuth extends StatefulWidget {
  @override
  ViewUserAuthState createState() => ViewUserAuthState();
}

class ViewUserAuthState extends State<ViewUserAuth> {
  String? _selectedDIC;
  ...
  void _navigateToPage(String? value) {
    ...
    if (value == "102586") {
      Navigator.push(context, MaterialPageRoute(builder: (context) => ViewUserDataAuth()));
