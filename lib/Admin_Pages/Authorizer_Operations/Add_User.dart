...
class AddUserAuth extends StatefulWidget {
  @override
  AddUserAuthState createState() => AddUserAuthState();
}

class AddUserAuthState extends State<AddUserAuth> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 10),
                    Text(
                      'Enter Details of New Authorizer',
                      style: TextStyle(
                          fontSize: 20.0,
