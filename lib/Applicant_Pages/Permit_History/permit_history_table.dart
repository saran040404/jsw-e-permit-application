...
class PermitHistoryTable extends StatefulWidget {
  @override
  _PermitHistoryTableState createState() => _PermitHistoryTableState();
}

class _PermitHistoryTableState extends State<PermitHistoryTable> {
  @override
