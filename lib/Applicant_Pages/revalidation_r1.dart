...
import 'package:jsw_epermit/Applicant_Pages/revalidation_r2.dart';

class Renewal1 extends StatefulWidget {
  @override
  _Renewal1State createState() => _Renewal1State();
}

class _Renewal1State extends State<Renewal1> {
  String _holderName = '';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Permit Revalidation 1'),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                height: 50,
                child: ElevatedButton(
                  onPressed: () => _viewRenewal2(context),
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all<Color>(Colors.red),
                  ),
                  child: Text('Permit Revalidation 2'),
                ),
              ),
            ],
          ),
  ...
  void _viewRenewal2(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Renewal2()),
    );
